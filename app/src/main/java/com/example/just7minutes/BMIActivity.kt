...
import com.example.just7minutes.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private fun displayBMIResult(bmi: Float){
        ...
        if (bmi.compareTo(15f) <= 0){
            ...
            bmiDescription = "Oops! You really need to better care of yourself! Eat more!"
            ...
            bmiLabel = "Overweight"
            bmiDescription = "Oops! You really need to better care of yourself! Workout more!"
        ...
        // to convert big values like 12.2222222 to 12.22
